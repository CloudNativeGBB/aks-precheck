...
function buildcluster () {
    ...
    echo "Creating the service-tracker namespace..."
    kubectl create ns service-tracker
...
#function buildapp () {
    ...
    # az group deployment create --resource-group $RGNAME --template-file ../arm/app-Insights.json --parameters type=Node.js name=$APPINSIGHTSNAME regionId=eastus
...
function deployapp () {
    ...
    kubectl apply -f /cnab/app/manifests

    echo "Waiting 60 seconds for external IP creation..."   
    sleep 60
